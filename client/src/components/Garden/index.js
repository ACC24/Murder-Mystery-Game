  ...
  constructor(props) {
    ...
    this.state = {
      ...
      map: {
        name: "my-map",
        areas: [
          { name: "sheddoor", coords: [901, 384, 947, 375, 945, 569, 901, 559], shape: "poly", message: "You opened the door to the shed, looks like there's some printed search results for 'Deadliest weed killers' items in the shed seem to have been thrown around" },
          ...
          { name: "pearls", coords: [532, 660, 540, 668, 551, 663, 558, 650, 549, 650, 542, 657], shape: "poly", message: "You found some pearls on the ground, they seem to be from a neacklace that was torn" },
